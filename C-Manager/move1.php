...
$sql= "INSERT INTO move (Name, Email, Mobile, Aadhaar, Destination, Reason, Time) values ('$name','$email','$mobile','$id','$destination','$reason','$time')";
$conn->query($sql);
    $url="https://www.sms4india.com/api/v1/sendCampaign";
$message = urlencode("Hi ".$name."! You are permited to visit ".$destination." at ".$time." for 30 minutes.");// urlencode your message
$curl = curl_init();
